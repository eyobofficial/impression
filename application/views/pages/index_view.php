...
<html lang="en">
    <head>
        <!-- META -->
        <meta charset="UTF-8">
        <meta name="author" content="Eyob Tariku <eyobtariku@gmail.com><?php echo base_url('" />
        <meta name="d'); ?>escription" content="Here goes description">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="recent-work-area">
                                <div id="recent-work" class="recent-work-content">
                                    <div class="item">
                                        <img src="<?php echo base_url('assets/images/work/1.jpg'); ?>" class="img-responsive" width="1365" height="767" alt="">
                                    </div><!-- END OF TESTIMONIAL ITEM -->
                                    <div class="item">
                                        <img src="<?php echo base_url('assets/images/work/2.jpg'); ?>" class="img-responsive" width="1365" height="767" alt="">
                                    </div><!-- END OF TESTIMONIAL ITEM -->
                                    <div class="item">
                                        <img src="<?php echo base_url('assets/images/work/3.jpg'); ?>" class="img-responsive" width="1365" height="767" alt="">
                                    </div><!-- END OF TESTIMONIAL ITEM -->
                                </div>
                    ...
                    <div class="row">
                        <div id="client" class="owl-carousel owl-theme col-lg-12">
                            <div class="item client-item">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/images/client/1.png'); ?>" width="140" height="46" alt=""><!-- CLIENT LOGO -->
                                </a>
                            </div><!-- END OF /. CLIENT ITEM 1 -->
                            <div class="item client-item">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/images/client/2.png'); ?>" width="140" height="46" alt=""><!-- CLIENT LOGO -->
                                </a>
                            </div><!-- END OF /. CLIENT ITEM 2 -->
                            <div class="item client-item">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/images/client/3.png'); ?>" width="140" height="46" alt=""><!-- CLIENT LOGO -->
                                </a>
                            </div><!-- END OF /. CLIENT ITEM 3 -->
                            <div class="item client-item">
                                <a href="#">
                                    <img src="<?php echo base_url('assets/images/client/4.png'); ?>" width="140" height="46" alt=""><!-- CLIENT LOGO -->
                                </a>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="blog-item wow fadeInDown animated" data-wow-delay="0.2s">
                                <a href="blog-right-sidebar.html">
                                    <img src="<?php echo base_url('assets/images/blog/1.jpg'); ?>" width="350" height="230" alt="">
                                </a>
                        ...
                        <div class="col-md-4">
                            <div class="blog-item wow fadeInDown animated" data-wow-delay="0.4s">
                                <a href="blog-right-sidebar.html">
                                    <img src="<?php echo base_url('assets/images/blog/2.jpg'); ?>" width="350" height="230" alt="">
                                </a>
                                <div class="blog-caption">
                                    <div class="title">
                                        <div class="meta">
                        ...
                        <div class="col-md-4">
                            <div class="blog-item wow fadeInDown animated" data-wow-delay="0.6s">
                                <a href="blog-right-sidebar.html">
                                    <img src="<?php echo base_url('assets/images/blog/3.jpg'); ?>" width="350" height="230" alt="">
                                </a>
                                <div class="blog-caption">
                                    <div class="title">
                                        <div class="meta">
